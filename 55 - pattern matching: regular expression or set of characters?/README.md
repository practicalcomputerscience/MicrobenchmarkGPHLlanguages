...
AssemblyScript |  | yes | OK | _char_set_ is a set of allowed characters in both cases, compiled from codepoints | | 2026-05-24
Awk (GNU) | yes |  | OK | non-POSIX patterns: _"[!-~]"_, _"[A-Za-z0-9]"_ | | 2026-07-24
...
(Object) Free Pascal | yes |  | OK | non-POSIX patterns: _'[!-~]'_, _'[A-Za-z0-9]'_ | | 2026-07-19
...
Haskell | yes | | OK | non-POSIX patterns: _"^[!-~]$"_, _"^[A-Za-z0-9]$"_ | | 2026-07-29
...
Lua    |     | |    | Lua doesn't support regular expressions (and may never do it) | | 2026-07-31
...
Picat |  |  | OK | _CharSet_ is a string of allowed characters in both cases, compiled from codepoints | | 2026-06-16
...
Standard ML (MLton) | yes |  | OK | non-POSIX patterns: _"^[!-~]$"_, _"^[A-Za-z0-9]$"_ | | 2026-05-30
