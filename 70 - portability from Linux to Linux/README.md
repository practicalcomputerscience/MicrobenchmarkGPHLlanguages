...
- intepreted languages ("scripting languages") like Lua, Perl 5, PowerShell, Python, Racket Scheme, Ruby, Smalltalk or Tcl which usually depend on some prior language related installation
