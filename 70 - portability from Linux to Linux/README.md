...
- intepreted languages ("scripting languages") like Lua, Perl 5, PowerShell, Python, Ruby, or Smalltalk which usually depend on some prior language related installation
