...
- intepreted languages ("scripting languages") like Gforth, Lua, Oberon (OBC), Perl 5, PowerShell, Python, Racket Scheme, Ruby, Smalltalk or Tcl which usually depend on some language related installation
