...
Inko              | 230 | compiled, very young language: lots of user-defined functions needed; also a construct is used to avoid repeated, individual access to array elements with _x.get(i).or_panic_ and _x.get(i - 1).or_panic_ | 2026-08-17
Modula-2 (GNU)    | 230 | compiled, very mature language: some user-defined functions needed | 2026-07-18
