/* graph_4coloring_Germany2f_Scryer.pl
   ...
   test on Scryer Prolog v.e7ac3ae, 2025-11-12: OK!

   run program in Ubuntu 24 LTS: $ scryer-prolog ./graph_4coloring_Germany2f_Scryer.pl
                                 $ ./exe_times_statistics_for_one_test_case_in_cwd2 "scryer-prolog ./graph_4coloring_Germany2f_Scryer.pl"
...
/* output:
$ time scryer-prolog ./graph_4coloring_Germany2f_Scryer.pl
...
/* end of graph_4coloring_Germany2f_Scryer.pl */
