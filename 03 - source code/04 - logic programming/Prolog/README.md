...
Installation tips: to build and install XSB Prolog correctly, even in a basic version, is a little bit tricky from my point of view.

TBD

Building a standalone executable is apparently not supported in XSB Prolog. But when the source code file didn't change, the _xsb_ system is using a formerly generated byte code file, here named _graph_4coloring_Germany2e_XSB.xwam_, at the next execution: _$ xsb /home/booser/scripts/Prolog/XSB_Prolog/graph_4coloring_Germany2e_XSB.pl_

By the way: here, I measured the execution time with command: _./exe_times_statistics_for_one_test_case_in_cwd2 "xsb /home/booser/scripts/Prolog/XSB_Prolog/graph_4coloring_Germany2e_XSB.pl --quietload"_
