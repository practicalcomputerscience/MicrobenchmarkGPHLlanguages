...
What's unkown in Ciao, is predicate _nth0()_, which I changed to _nth()_, which I made available with clause: _:- use_module(library(lists))._; see at [core/lib/lists.pl](https://github.com/ciao-lang/ciao/blob/master/core/lib/lists.pl).
...
Its a much handier problem than Germany, and its core clauses could also serve as a starting point for other hard to handle Prolog systems, like [Tau Prolog](#tau-prolog---prolog-for-the-web) for example, or generally systems for solving Constraint Satisfaction Problems.
...
With about 215 milliseconds, the execution time of the SWI Prolog version is surprisingly fast, and thus beating the winner of the map coloring problem of Germany, that is [Picat](https://github.com/practicalcomputerscience/MicrobenchmarkGPHLlanguages/tree/main/03%20-%20source%20code/04%20-%20logic%20programming/Picat#microbenchmark-program-in-picat), which takes about 240 milliseconds to run.
...
While I also tumbled into well reputated but deprecated [B-Prolog](https://www.picat-lang.org/bprolog/) (1994 - 2014), and learned about "logic-based" programming language [Picat](https://picat-lang.org/), I haven't seen their close relationship at first.
