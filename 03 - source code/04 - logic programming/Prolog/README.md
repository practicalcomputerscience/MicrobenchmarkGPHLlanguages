...
Like ECLiPSe, ErgoAI also features a graphical user interface (GUI): _ErgoAI reasoner can start either in the studio mode, as part of the ErgoAI Studio IDE (suitable for development), or as a command line application._, seen here at: [Starting the ErgoAI System](https://sites.google.com/coherentknowledge.com/ergoai-tutorial/ergoai-tutorial/home#h.p_ID_539).
...
**Installation tips**: I downloaded file _ergoAI_3.0.run_ from here: https://github.com/ErgoAI/.github/releases, and ran this file in a working directory for ErgoAI:
