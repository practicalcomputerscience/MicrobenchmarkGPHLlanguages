{-
graph_4coloring_Australia.curry

a program for the Curry2Go compiler: https://www.curry-lang.org/curry2go/

2026-06-20

build on Ubuntu 24 LTS: $ curry2goc graph_4coloring_Australia
run on Ubuntu 24 LTS:   $ ./graph_4coloring_Australia
                        <see output below>
                        $ time ./graph_4coloring_Australia | wc -l
...
-- end of graph_4coloring_Australia
