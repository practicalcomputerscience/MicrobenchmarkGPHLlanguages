...
Again, we see the phenomenon of multiple implementations: PAKCS, KiCS2, Curry2Go and MCC: https://www.curry-lang.org/implementations/overview/, with MCC being dead already because is needs 32-bit systems: http://danae.uni-muenster.de/curry/
