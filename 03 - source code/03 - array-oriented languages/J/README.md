...
Although, using only ASCII characters for the source code is not a free lunch, since APL's unique symbols ("glyphs") are more visually distinct than J's strings of ASCII characters.
