#| random_streams_for_perf_stats_8batch -- this is the Gambit Scheme version
...
build on Ubuntu 24 LTS: (don't do like this because no batteries included and old: $ sudo apt install gambc)
                        ...
                        $ gsc -exe ./random_streams_for_perf_stats_8batch.scm
                        => this is apparently as fast as this compilation:
                          gsc -exe -cc gcc -cc-options -O3 ./random_streams_for_perf_stats_8batch.scm

run on Ubuntu 24 LTS:   $ ./random_streams_for_perf_stats_8batch
                        $ time ./random_streams_for_perf_stats_8batch
                        $ sudo perf stat -r 20 ./random_streams_for_perf_stats_8batch
...
(define END 8192)  ; limit of arguments for append function in Gambit Scheme:
...
(define (write_to_file filename content)  ; this is the version from final version random_streams_for_perf_stats.scm (1-batch)
...
; end of random_streams_for_perf_stats_8batch.scm
