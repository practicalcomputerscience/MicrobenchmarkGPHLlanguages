# random_streams_for_perf_stats.tcl
#
# 2026-06-19
#
# run on Ubuntu 24 LTS: $ tclsh random_streams_for_perf_stats.tcl
#                       $ time tclsh random_streams_for_perf_stats.tcl => real	0m0.123s
#
#
...
# $
#
# mostly transpiled from random_streams_for_perf_stats.groovy with Duck.ai and Google AI
...
# end of random_streams_for_perf_stats.tcl
