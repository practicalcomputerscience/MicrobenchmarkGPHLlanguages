...
ARC = Automatic Reference Counting is a memory management method to automatically manage the allocation and deallocation of objects. It tracks the number of strong references to each object and deallocates them when there are no more references, helping to prevent memory leaks: https://en.wikipedia.org/wiki/Automatic_Reference_Counting
...
Otherwise, I downloaded this tarball file with the pre-compiled binary _blaise-v0.13.0-linux-x86_64.tar.gz_ from here: https://github.com/graemeg/blaise/releases/tag/v0.13.0
...
The contrast in the number of source lines of code between this implementation and the implementation in Object Free Pascal mode is (still) stark:
