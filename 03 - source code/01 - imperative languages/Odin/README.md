...
This becomes clearer at this code snippet from the complete microbenchmark program in its old version, where the available character set is being composed like this:
