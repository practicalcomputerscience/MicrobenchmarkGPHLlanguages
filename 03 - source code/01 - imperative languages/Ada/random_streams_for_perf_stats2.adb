--  random_streams_for_perf_stats2.adb
--
...
--  2026-06-24: copied the loops for writing the little strings into the big strings from the SPARK variant
--
--
--  build on Ubuntu 24 LTS: $ alr init --bin random_streams_for_perf_stats2
--                          $ cd random_streams_for_perf_stats2
--                          $ alr build --release
--                          $ alr run
--
--  run on Ubuntu 24 LTS:   $ time ./bin/random_streams_for_perf_stats2
--                          $ sudo perf stat -r 20 ./bin/random_streams_for_perf_stats2
--
--  changes to random_streams_for_perf_stats2_config.gpr:
...
procedure random_streams_for_perf_stats2 is
...
end random_streams_for_perf_stats2;
