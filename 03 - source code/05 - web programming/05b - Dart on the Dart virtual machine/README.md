...
- nowadays, Dart is strictly, sound, and statically typed, while applying type inference and optionally providing the _dynamic_ type, which defers type checking to the runtime
