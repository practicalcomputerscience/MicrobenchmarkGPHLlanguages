...
[Forth]() | so far, I haven't encountered any other language that comes so close to C's role as "portable assembly language" | "true" stack-oriented programming is still very hard in the early ages of "AI coding" | #1 open source implementation Gforth isn't suitable for low-level system programming with using its virtual machine in Linux
