...
This task takes more effort, because first we have to tell Ubuntu about the installed versions, something which then creates a menu to provide the possibility to select a version:
