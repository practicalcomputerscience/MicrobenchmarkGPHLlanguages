...
Awk (GNU) | C; partly self-hosted | https://github.com/sbdtu5498/gawk/tree/master
...
COBOL | _GnuCOBOL translates COBOL into C and compiles the translated code using the native C compiler.._ | [A clone of the sourceforge GnuCOBOL compiler from COBOL to C](https://github.com/OCamlPro/gnucobol/tree/gitside-gnucobol-3.x)
...
(Object) Free Pascal | self-hosted | https://www.freepascal.org/faq.html#WhatIsFP
...
Modula-3 (CM3) | CM3 compiler is self-hosted; bootstrapping with C++ | https://github.com/modula3/cm3/releases
...
Oberon (OBC) | OCaml for the compilation to bytecode for its own virtual machine named "Keiko Abstract Machine", which, together with a runtime system, is implemented in C | https://spivey.oriel.ox.ac.uk/corner/Design_overview_for_OBC
